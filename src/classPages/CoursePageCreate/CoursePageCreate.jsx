...
import CreateGeneral from '../../classComponents/CourseCreateTabs/CreateGeneral.jsx';
import CoursesModel from '../../classModels/CoursesModel.js';
import CreateApartados from '../../classComponents/CourseCreateTabs/CreateApartados.jsx';
import CreateCategorias from '../../classComponents/CourseCreateTabs/CreateCategorias.jsx';
import CreateDocs from '../../classComponents/CourseCreateTabs/CreateDocs.jsx';

export default function CoursePageCreate({ aula }) {
        ...
        <div className='dashboard-option-container'>
            ...
            <div className='courseEdit-wrapper'>
                    <div className='editOptions-container'>
                        <h2 className='section-header'>Creación de curso</h2>

                        <div className='tab-container' id='margin-top'>
                        <button
                            ...
                            {activeTab === 'general' && <CreateGeneral handleTabChange={handleTabChange} aula={aula} newCourseId={newCourseId} setNewCourseId={setNewCourseId}/>}
                            {activeTab === 'apartados' && <CreateApartados aula={aula} newCourseId={newCourseId}/>}
                            {activeTab === 'categorias' && <CreateCategorias newCourseId={newCourseId}/> }
                            {activeTab === 'docs' && <CreateDocs newCourseId={newCourseId}/>}
                    ...
                    <div className='classPreview-container'>
                        <div className='preview-header-container'>
                            ...
                            <button className='refresh-btn' onClick={handleRefresh} disabled={!newCourseId}>
