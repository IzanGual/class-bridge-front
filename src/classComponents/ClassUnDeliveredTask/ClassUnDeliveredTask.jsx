import './ClassUnDeliveredTask.css';
import { useNavigate } from 'react-router-dom'; // Importa el hook useNavigate


export default function ClassUnDeliveredTask({ task, aula }) {
    ...
    return (
        <div onClick={handleClick} className="class-undone-task">
            <svg className='svg-task' width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='undone-task-text-container'>
            ...
            <div className='subheader-action-container'>
                <span>{task.nombre_curso}</span>
                <div className='svg-correct-container'>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_8_46)">
                    <path d="M18.3333 1.66663L9.16666 10.8333M18.3333 1.66663L12.5 18.3333L9.16666 10.8333M18.3333 1.66663L1.66666 7.49996L9.16666 10.8333" stroke="#FF0000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </g>
                    <defs>
