    ...
    return (
        <div className='tab-info-container'>
            ...
            <input
                ...
                disabled={!selectedApartado}
            />
            <div className='save-cancel-container'>
                <div className='save-container'>

                    <span>Guardar cambios ---</span>
                    <button className='save-btnn' disabled={!selectedApartado} onClick={handleSave}>
                ...
                <div className='cancel-container'>
                    ...
                    <span>Eliminar ---</span>
                    <button className='delete-btn' disabled={!selectedApartado} onClick={handleApartadoDelete}>
                        <svg width="25" height="25" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
